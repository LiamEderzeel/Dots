...
M.setup = function()
  ...
  vim.g.dashboard_custom_header = O.p.dashboard.custom_header

  vim.g.dashboard_default_executive = O.p.dashboard.search_handler

  vim.g.dashboard_custom_section = O.p.dashboard.custom_section
